        ...
        <div className="w-full max-w-lg flex flex-col items-center gap-6 p-8">
          ...
          <div className="w-full flex flex-col gap-3">
            ...
            <button
              ...
              disabled={loading}
              className="w-full px-6 py-2.5 rounded-lg bg-white/5 text-white font-medium text-base border border-white/10 hover:bg-white/10 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
            >
              Avatar Management
            </button>
          </div>
